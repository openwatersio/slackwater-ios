...
// held-out validation window with Neaps (the app's shipping predictor),
...
let package = Package(
    ...
    platforms: [.macOS(.v14)],
    dependencies: [
        .package(url: "https://github.com/openwatersio/neaps", from: "1.0.0"),
    ],
    targets: [
        .executableTarget(
            name: "fit-validation",
            dependencies: [.product(name: "Neaps", package: "neaps")]),
    ])
