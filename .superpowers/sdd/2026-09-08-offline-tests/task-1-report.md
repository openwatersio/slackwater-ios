...
- Real `ChsFitter` checks fit 50 days of Victoria and score the held-out final 10 days below 0.20 m RMSE with at least 800 matched predictions; Dodd fits more than 20,000 projected samples with at least 20 constituents and residual below 0.75 kn.
