...
final class FillFieldTests: XCTestCase {
    ...
    //     SlackwaterKit's own `CurrentStation.speeds(from:to:step:)` — the exact
    ...
    // or in FillField — both paths hand raw constituents to SlackwaterKit and
    ...
    func testSyntheticGoldenTwoInstants() throws {
        ...
        for t in [Date(timeIntervalSince1970: 1_787_227_200),           // 2026-08-20T12:00:00Z
            ...
            // SlackwaterKit produced: east = speed*sin(bearing),
    ...
    // constituents fed straight into SlackwaterKit by a path that never calls
